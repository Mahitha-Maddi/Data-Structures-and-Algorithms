...
public class FordFulkerson {
    ...
    private void printAugmentedPaths(List<List<Integer>> augmentedPaths) {
        ...
        augmentedPaths.forEach(path -> {
            path.forEach(i -> System.out.print(this.vertices[i] + " "));
            System.out.println();
        });
    }
    ...
    public static void main(String args[]){
        char[] vertices={'s','1','2','3','4','t'};
        FordFulkerson ff = new FordFulkerson(vertices);
        int[][] capacity = {{0, 0, 6, 0, 0, 0},
                            {10, 0, 2, 0, 2, 0},
                            {4, 0, 0, 0, 5, 0},
                            {0, 4, 0, 0, 0, 6},
                            {0, 6, 4, 6, 0, 0},
        ...
        System.out.println("\nMaximum capacity " + ff.maxFlow(capacity, 0, 5));
    }
}
