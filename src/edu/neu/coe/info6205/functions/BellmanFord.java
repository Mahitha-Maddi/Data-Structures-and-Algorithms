...
import edu.neu.coe.info6205.functions.Graph1.Edge;
...
public class BellmanFord {
    ...
    public Map<Character, Integer> getShortestPath(Graph1 graph, Character sourceVertex, char[] vertices) {
    ...
    public static void main(String args[]) {
        ...
        List<Edge> edges = Arrays.asList(new Edge('A', 'B', -1), new Edge('A', 'C', 4),
                new Edge('B', 'C', 3),
                new Edge('B', 'D', 2), new Edge('D', 'B', 1), new Edge('D', 'C', 5),
                new Edge('B', 'E', 2), new Edge('E', 'D', -3));
