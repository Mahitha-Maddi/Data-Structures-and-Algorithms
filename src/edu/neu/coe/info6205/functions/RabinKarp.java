...
public class RabinKarp {
    ...
    public void patternSearch(char[] text, char[] pattern){
        ...
        System.out.println("Pattern is found at the position: "+ (i-1));
            }
            if(i < n - m + 1) {
        ...
        System.out.println("Reached end of the iteration");
    ...
    public static void main(String args[]){
        ...
        System.out.println("Text given is ABCADCBABABCDABCD and pattern is BCD");
        //System.out.println("Pattern is found at the position: "+ rks.patternSearch("ABCADCBABABCDABCD".toCharArray(), "BCD".toCharArray()));
        rks.patternSearch("ABCADCBABABCDABCD".toCharArray(), "BCD".toCharArray());
    }
}
